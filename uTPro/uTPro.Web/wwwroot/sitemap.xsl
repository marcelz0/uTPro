...
<xsl:stylesheet
            ...
            <body class="ph3 pb3 mid-gray">
                <header class="mw8 pv4 center">
                    ...
                    <p>
                        ...
                        You can find more information about XML sitemaps on <a href="https://sitemaps.org" class="link blue" target="_blank">sitemaps.org</a>.
                    </p>
                </header>
                ...
                <footer class="mw8 center pv4 tc">
                    Generated by the <a href="https://www.t4vn.com" target="_blank">T4VN</a>
                </footer>
    ...
    <xsl:template match="xhtml:link">
        ...
        <p>
            <strong>Xhtml: </strong>
            <a href="{$altloc}" class="mr2 link blue" target="_blank">
                <xsl:value-of select="@href"/>
            </a>
    ...
    <xsl:template match="image:image">
        ...
        <p>
            <strong>Image: </strong>
            <a href="{$loc}" class="mr2 link blue" target="_blank">
                <xsl:value-of select="image:loc"/>
            </a>
    ...
    <xsl:template match="video:video">
        ...
        <p>
            ...
            <a href="{$thumb_loc}" class="dib mr2 ph2 pv1 tracked lh-solid link white bg-silver hover-bg-blue br-pill" target="_blank">
                thumb
            </a>
